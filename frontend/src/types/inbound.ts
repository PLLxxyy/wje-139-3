...
export type InboundItem = { id: number; productId: number; batchNo: string; expectedQty: number; actualQty: number; qcResult: QCResult; binLocationId: number; shelved?: boolean };
